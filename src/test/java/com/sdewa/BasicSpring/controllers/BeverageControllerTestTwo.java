...
public class BeverageControllerTestTwo {
    ...
    public void testGetBeverage() {
        System.out.println("Running testGetBeverage in BeverageControllerTestTwo");
    }

    @Test
    public void testGetBeverageById() throws Exception {
        Long beverageId = 1L;
        BeverageEntity mockBeverage = BeverageControllerMock.getMockBeverageControllerWithIdAndNumber(beverageId,
                "12345");
    ...
    public void testCreateBeverage() throws Exception {
        ...
        BeverageEntity mockBeverageEntity = BeverageControllerMock.getMockBeverageControllerWithIdAndNumberAndName(mockBeverageRequest, beverageId);
    ...
    public void testDeleteBeverage() throws Exception {
        long beverageId = 1L;
        BeverageEntity mockBeverageEntity = BeverageControllerMock.getMockBeverageControllerWithIdAndNumber(beverageId, "12345");
